$(document).ready(function() {
  if ($('form[name="myForm"] center table tbody tr th').html() == 'Hosp. Notify Information Log')
  ...
  $('.hospitalNotify').click(function() {
    ...
    $('textarea[name="user_comments"]').html('Hospital notified. No further orders requested.');
  });
